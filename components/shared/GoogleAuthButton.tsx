...
export function GoogleAuthButton({ label, loading, disabled, onClick }: GoogleAuthButtonProps) {
  return (
    <button
      ...
      className="flex h-14 w-full items-center justify-center gap-3 rounded-full border border-white/10 bg-white/[0.04] text-base font-light text-white transition-colors hover:border-white/25 hover:bg-white/[0.08] disabled:opacity-60 sm:h-[60px]"
    >
